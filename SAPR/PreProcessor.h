...
namespace SAPR {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ задатьПеременныеToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->задатьПеременныеToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->препроцессорToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->открытьToolStripMenuItem,
					this->сохранитьToolStripMenuItem, this->задатьПеременныеToolStripMenuItem
			});
			...
			this->открытьToolStripMenuItem->Size = System::Drawing::Size(183, 22);
			...
			this->сохранитьToolStripMenuItem->Size = System::Drawing::Size(183, 22);
			...
			// 
			// задатьПеременныеToolStripMenuItem
			// 
			this->задатьПеременныеToolStripMenuItem->Name = L"задатьПеременныеToolStripMenuItem";
			this->задатьПеременныеToolStripMenuItem->Size = System::Drawing::Size(183, 22);
			this->задатьПеременныеToolStripMenuItem->Text = L"Задать переменные";
			// 

...
System::Void SAPR::PreProcessor::открытьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e, String^ DataFileName)
{
...
System::Void SAPR::PreProcessor::PreProcessor_Load(System::Object^ sender, System::EventArgs^ e)
{
	...
	if (this->DataFileName != "SAPRDataPreProcessor.txt" && this->DataFileName != nullptr) {
		SAPR::PreProcessor::открытьToolStripMenuItem_Click(this, e, this->DataFileName);
	}
